...
//
//		ADeclaration[] listDecl = (ADeclaration[])node.getDeclarations().toArray(new ADeclaration[0]);
...
//	{
//		AVariableSpec[] list = (AVariableSpec[])node.getVariableSpec().toArray(new AVariableSpec[0]);
...
//		p("{\n");
//
//		AStm[] listStm = (AStm[])node.getStm().toArray(new AStm[0]);
...
//
//	       	AExp[] listExp = node.getExp().toArray(new AExp[0]);
...
//		}
//
//		Iterator<AExp> iter2 = node.getExp().iterator();
//		while (iter2.hasNext()){
//			AExp e = iter2.next();
//			e.apply(this);
//		}
...
//			p(listId[i].getText()+",");
//		}
//		listId[listId.length-1].getText();
//
//		node.getTypeExp().apply(this);
//	}
//
...
//    	{
//    		startl();
//    		TId[] listId = node.getId().toArray(new TId[0]);
//			for(int i=0; i<listId.length - 1; i++)
//			{
//				p(listId[i].getText()+", ");
//			}
...
//    	{
//
//    		AExp[] listId = (AExp[])node.getLvalue().toArray(new AExp[0]);
//    		AExp[] listId2 = (AExp[])node.getExp().toArray(new AExp[0]);
//
//			for(int i=0; i<listId.length - 1; i++)
//			{
//	    		listId[i].apply(this);
...
//			}
//			listId[listId.length-1].apply(this);
//			listId2[listId2.length-1].apply(this);
//    	}
//
...
//        {
//        	List<AExp> list1 = new ArrayList<AExp>(node.getIds());
//        	for(AExp v:list1)
//        	{
//        		v.apply(this);
//        	}
//        	p(":=");
//
//			Iterator<AExp> iter = node.getExp().iterator();
//			while (iter.hasNext()){
//				AExp e = iter.next();
//				e.apply(this);
//			}
...
//    	{
//     		List<AVariableSpec> listVar = new ArrayList<AVariableSpec>(node.getVariableSpec());
//
//     		for(AVariableSpec v : listVar)
//        	{
//        	v.apply(this);
//        	}
//    	}
...
//    	{
//    		//type_spec+
//    		Iterator<ATypeSpec> iter = node.getTypeSpec().iterator();
//    		while (iter.hasNext()){
//			ATypeSpec t = (ATypeSpec)iter.next();
//			t.apply(this);
//    		}
//    	}
//
...
//        	{
//    	 	//exp*
//			AExp[] listExp = (AExp[])node.getExp().toArray(new AExp[0]);
//			for(int i=0; i<listExp.length - 1; i++)
//			{
//				listExp[i].apply(this);
//				p(",");
//			}
//			listExp[listExp.length-1].apply(this);
//        	}
//
//        	p(")\n");
//    	}
...
//
//    		{
//    	List<AStm> if_copy = new ArrayList<AStm>(node.getIfBlock());
...
//            	}
//    		{
//            	List<AStm> else_copy = new ArrayList<AStm>(node.getElseBlock());
//            	boolean elseblock=false;
//            	if (else_copy.size()>1){
//            		elseblock=true;
//            	} else {}
//
//            	for(AStm s : else_copy)
//            	{
//                	s.apply(this);
//            	}
//            	if (elseblock==true) {
...
//    		}
//    		//switch_clause*
//		ASwitchClause[] listSwitch = (ASwitchClause[])node.getSwitchClause().toArray(new ASwitchClause[0]);
...
//
//		//stm*
//		Iterator<AStm> iter = node.getStm().iterator();
//		while (iter.hasNext()){
//			AStm p = (PStm)iter.next();
//			p.apply(this);
//		}
//	}
//
...
//    	}
//
//    	public void caseANotEqBinaryOp(ALtEqBinaryOp node)
//    	{
//    		p("!=");
//    	}
//
